...
export const slides = [
  ...
  { id: 's-hook',         file: '01-hook.html',         phase: 'F1', archetype: 'hook',       headline: 'Residentes acertam 41% em avaliação de evidência — mas a confiança é alta, mesmo nas respostas erradas',                                     timing: 60,   clickReveals: 2, customAnim: 's-hook',           narrativeRole: 'hook',       tensionLevel: 3, narrativeCritical: true },
