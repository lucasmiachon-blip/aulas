...
export const slides = [
  ...
  { id: 's-hook',         file: '01-hook.html',         phase: 'F1', archetype: 'hook',       headline: '80 revisões sistemáticas foram publicadas hoje. Quantas você consegue avaliar?',                                     timing: 60,   clickReveals: 1, customAnim: 's-hook',           narrativeRole: 'hook',       tensionLevel: 3, narrativeCritical: true },
  { id: 's-contrato',     file: '02-contrato.html',     phase: 'F1', archetype: 'cards',      headline: 'Ao final, 3 perguntas que você faz a toda MA antes de mudar sua conduta',                                            timing: 45,   clickReveals: 0, customAnim: null,             narrativeRole: 'setup',      tensionLevel: 1, narrativeCritical: false },

  // ── Interação 1: Checkpoint de engajamento ──
  { id: 's-checkpoint-1', file: '03-checkpoint-1.html', phase: 'I1', archetype: 'checkpoint', headline: 'Uma MA mostra RR 0,91 (IC 0,85–0,97). Você muda sua conduta?',                                                     timing: 90,   clickReveals: 2, customAnim: 's-checkpoint-1', narrativeRole: 'checkpoint', tensionLevel: 3, narrativeCritical: true },
