...
export const slides = [
  ...
  { id: 's-hook',         file: '01-hook.html',         phase: 'F1', archetype: 'hook',       headline: '1.330 trials retratados → 3.902 MAs contaminadas, 20% mudam resultado, 157 guidelines afetadas',               timing: 60,   clickReveals: 2, customAnim: 's-hook',           narrativeRole: 'hook',       tensionLevel: 3, narrativeCritical: true },
