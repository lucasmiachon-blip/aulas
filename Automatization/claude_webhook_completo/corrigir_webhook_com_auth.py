#!/usr/bin/env python3
"""
🔧 CORRETOR AUTOMÁTICO COM AUTENTICAÇÃO
...
print("eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2MDExZmEyYS0xODBjLTRmZDgtYTM2ZS0yNmFjMDM0MWNmNzMiLCJpc3MiOiJuOG4iLCJhdWQiOiJwdWJsaWMtYXBpIiwiaWF0IjoxNzYxNjEwMTkxfQ.KIpaTZQO3B82DYWIYJ0B6DXhrAlBX5ZRFfU-5usHwzY")
...
try:
    ...
    if not claude_workflow:
        ...
        print()
        print("💡 Crie o workflow primeiro com:")
        print("   python setup_claude_webhook.py")
        sys.exit(1)
